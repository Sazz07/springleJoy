...
const Summary = () => {
    return (
        <section className="p-6 bg-gray-100 text-gray-800">
            <h1 className='text-center py-5 text-2xl font-bold'>We Server</h1>
            <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-400 text-gray-300">
                ...
                <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-400 text-gray-100">
                    <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-violet-400">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="h-9 w-9 text-gray-800">
